...
/*
 * Get all members of the user property set
 * @param user : varchar : unique user id
 * @param property : string : name of user property
 */
DAO.prototype.getUserSet = function(user, property, callback){
  key = this.getUserPropertyKey(user, property);
